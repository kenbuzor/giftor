...
Color kTextColorWithOpacity = const Color(0xff000000).withValues(alpha: 0.4);
...
TextStyle kAuthInputTextStyle = GoogleFonts.spaceGrotesk(
  fontSize: 14.0,
...
final kDefaultBorderRadius = BorderRadius.circular(8.0);
...
//default sizedBox
const kSpaceBox = SizedBox(height: 8.0);
