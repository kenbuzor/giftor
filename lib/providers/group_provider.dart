...
class GroupProvider with ChangeNotifier {
  ...
  Color allowSelectionColor = const Color(0xff1323B4).withValues(alpha: 0.8);
  ...
  void setAuth(MyAuthProvider auth) {
    _authProvider = auth;
  }
  ...
  Future<void> allowSelection(String groupId) async {
    ...
    if (selectionStarted) {
      allowSelectionColor = const Color(0xff1323B4).withValues(alpha: 0.3);
    }
    notifyListeners();
  }
  ...
  Future<void> setSelectionStarted(String groupId) async {
    ...
    if (selectionStarted) {
      ...
      allowSelectionColor = const Color(0xff1323B4).withValues(alpha: 0.8);
